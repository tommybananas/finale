...
List.prototype.fetch = function(req, res, context) {
  ...
  //shallow boolean disables includes, unless a children query param with pipe delimited assocation names
  //is included, in which case we pick, from our white-list of available includes, what to include.
